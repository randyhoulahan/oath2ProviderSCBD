...
class provideroauth2scbd extends League\OAuth2\Client\Provider\scbd {

    // THE VALUES YOU WANT TO CHANGE WHEN CREATING A NEW PROVIDER.
    public $sskstyle = 'scbd';
    public $name = 'scbd'; // It must be the same as the XXXXX in the class name provideroauth2XXXXX.
    public $readablename = 'SCBD';
    public $scopes = array('firstname','lastname','email','accountid');
