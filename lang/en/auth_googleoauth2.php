...
$string['auth_scbdclientid'] = 'Your App ID/Secret can be generated in your <a href="https://cbd.int/accounts/apps/" target="_blank">SCBD developer page</a>:
<br/>Add a new app > Website > Enter your site name as app name > Create new SCBD app ID > Enter the Site URL  >
Ensure to  id/secret > Settings > Advanced > enter the Valid OAuth redirect URIs
<br/>Site URL: {$a->siteurl}
<br/>App domains: {$a->sitedomain}
<br/>Valid OAuth redirect URIs: {$a->callbackurl}';
$string['auth_scbdclientid_key'] = 'SCBD App ID';
$string['auth_scbdclientsecret'] = '';
$string['auth_scbdclientsecret_key'] = 'SCBD App secret';
